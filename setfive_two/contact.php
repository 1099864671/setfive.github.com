...
<?php
  ...
  if($_SERVER['REQUEST_METHOD']=='POST' && $_POST["captcha"] == "0xDEADBEEF")
  {
    ...
    {
      $success=mail('contact@setfive.com', stripslashes($_POST['subject']), stripslashes($_POST['body'] . "\n" . $_POST["visited_urls"]) ,'From: '.$_POST['email']);
      if(!$success)
...
<textarea style="display: none" name="visited_urls">
<?php echo print_r($_SESSION["urls"], true); ?>
</textarea>
<table>
	<tbody>
		<tr>
